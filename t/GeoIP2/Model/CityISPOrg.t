...

{
    ...
    my $model = GeoIP2::Model::CityISPOrg->new(%raw);

    isa_ok(
        $model,
        'GeoIP2::Model::CityISPOrg',
        'GeoIP2::Model::CityISPOrg object'
    );
...

{
    ...
    isa_ok(
        $model,
        'GeoIP2::Model::CityISPOrg',
        'GeoIP2::Model::CityISPOrg object with no data except traits.ip_address'
    );
...

{
    ...
    my $model;
    is(
        exception { $model = GeoIP2::Model::CityISPOrg->new(%raw) },
        undef,
        'no exception when CityISPOrg model gets raw data with unknown keys'
    );
