...

{
    ...
    test_model_class( 'GeoIP2::Model::CityISPOrg', \%raw );
}

{
    test_model_class_with_empty_record('GeoIP2::Model::CityISPOrg');
    test_model_class_with_unknown_keys('GeoIP2::Model::CityISPOrg');
}
