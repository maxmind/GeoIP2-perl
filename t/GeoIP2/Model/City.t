...

{
    ...
    my $model = GeoIP2::Model::City->new(%raw);
...

{
    ...
    isa_ok(
        $model,
        'GeoIP2::Model::City',
        'GeoIP2::Model::City object with no data except traits.ip_address'
    );
...

{
    ...
    my $model;
    is(
        exception { $model = GeoIP2::Model::City->new(%raw) },
        undef,
        'no exception when City model gets raw data with unknown keys'
    );
