...
If you use cpanminus, you can do it without downloading the tarball first:
    ...
    $ cpanm --reinstall --installdeps --with-recommends GeoIP2
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends GeoIP2
...
The code for this distribution is [hosted at GitHub](https://github.com/maxmind/GeoIP2-perl).
...
can submit an issue report [via the web](https://github.com/maxmind/GeoIP2-perl/issues)
).
